...
public class HBRecorder implements MyListener {
    ...
    /*Start screen recording with MediaProjection token*/
    public void startScreenRecordingWithMediaProjection(android.media.projection.MediaProjection projection) {
        Intent service = new Intent(context, ScreenRecordService.class);
        service.putExtra("mediaProjection", new MediaProjectionWrapper(projection));
